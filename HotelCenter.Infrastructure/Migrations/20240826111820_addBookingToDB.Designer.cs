...
namespace HotelCenter.Infrastructure.Migrations
{
    ...
    [Migration("20240826111820_addBookingToDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelCenter.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HotelCenter.Domain.Entities.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelCenter.Domain.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("HotelCenter.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HotelCenter.Domain.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
